...
class LLM:
    ...
    def retrieve(self, query, K):
        ...
        print(new_query)
        relevant_docs = self.db.similarity_search(new_query, k=K)
        # print(relevant_docs)
    ...
    def gen_img(self, objects):
        client = OpenAI(api_key=self.openai_api_key)
        objects_trans = translate(objects)
        # print(objects_trans)
        prompt = f"Generate an image of a {objects_trans}"
        print(prompt)
...
if __name__ == "__main__":
    ...
    asr_path = r"/data/vit/AIC2024/DATA/final_asr.json"
    llm = LLM()
    
    index_name = r"/data/vit/AIC2024/llm_index"
    ...
    # objects = "về biểu diễn thời trang với nhiều người mẫu nữ, mặc trang phục màu trắng hay beige. Buổi biểu diễn thời trang diễn ra tại 1 hòn đạo ở 1 quốc gia châu Phi .Trong video clip có cảnh bầu trời và nước biển màu xanh tại khách sạn nơi diễn ra buổi biễu diễn."
    # print(llm.gen_img(objects))
